  ...
  const mockData = [
    {
      ...
      srNo: 1,
      paraNumber: "P001",
      summary: "Introduction to regulatory compliance framework and its importance in maintaining organizational standards and legal requirements.",
      sentiment: "Positive",
      sentimentScore: 0.78
    },
    {
      ...
      srNo: 2,
      paraNumber: "P002",
      summary: "Discussion of challenges faced during implementation of new compliance protocols and potential mitigation strategies.",
      sentiment: "Negative",
      sentimentScore: -0.45
    },
    {
      ...
      srNo: 3,
      paraNumber: "P003",
      summary: "Overview of stakeholder engagement processes and communication strategies for effective policy implementation.",
      sentiment: "Neutral",
      sentimentScore: 0.12
    },
    {
    ...
    },
    {
      ...
      srNo: 7,
      paraNumber: "P007",
      summary: "Technical specifications and requirements for system integration and data management protocols.",
      sentiment: "Neutral",
      sentimentScore: 0.08
    },
    {
