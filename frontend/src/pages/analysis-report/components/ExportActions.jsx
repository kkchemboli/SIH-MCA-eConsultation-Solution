...
const ExportActions = ({ onExportPDF, onExportMarkdown, className = '' }) => {
  ...
  return (
    <div className={`flex flex-col sm:flex-row gap-3 ${className}`}>
      <Button
        ...
        loading={isExporting && exportType === 'markdown'}
        iconName="FileDown"
        iconPosition="left"
        className="flex-1 sm:flex-none"
      >
        {isExporting && exportType === 'markdown' ? 'Exporting...' : 'Export Markdown'}
      </Button>
